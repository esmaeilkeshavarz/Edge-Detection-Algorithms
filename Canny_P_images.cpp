/************************************************
     Canny edge detection with parallelisation
************************************************/
...
int main()
{
    ...
    GaussianBlur( image_gray, img_gray, Size(5,5), 3, 3);
    ...
    #pragma omp parallel for  default(shared)  private(i,j) num_threads(4) ordered schedule(dynamic,120) collapse(2)
